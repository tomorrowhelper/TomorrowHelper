...
public class FrescoUtil {
    ...
    private static final int DEFAULT_IMG_LOADING = R.drawable.ic_image_load;//默认加载中图片
    private static final int DEFAULT_IMG_FAILURE = R.drawable.ic_image_load;//默认加载失败图片
    private static final int DEFAULT_IMG_RETRY = R.drawable.ic_image_load;//默认重新加载的图片
