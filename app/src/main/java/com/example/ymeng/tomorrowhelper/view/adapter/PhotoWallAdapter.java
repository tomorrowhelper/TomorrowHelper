...
public class PhotoWallAdapter extends ArrayAdapter<String> implements AbsListView.OnScrollListener {
    ...
    public PhotoWallAdapter(@NonNull Context context, int resource, @NonNull String[] objects,
                            GridView photoWall) {
...
// 设置图片缓存大小为程序最大可用内存的1/8
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view;
        if (convertView == null) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.photo_item_layout, null);
        } else {
            view = convertView;
        }
        final ImageView photo = view.findViewById(R.id.photo_item_im);
        photo.setTag(url);
    ...
    private void setImageView(String imageUrl, ImageView imageView) {
        ...
        if (bitmap != null) {
            Log.e("TAG", "setImageView: Bitmap");
            imageView.setImageBitmap(bitmap);
        } else {
            Log.e("TAG", "setImageView: Resource");
     ...
     *
     * @param key public Bitmap getBitmapFromMemoryCache(String key) {
