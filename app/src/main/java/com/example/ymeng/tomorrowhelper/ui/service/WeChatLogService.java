...
public class WeChatLogService extends AccessibilityService {
    ...
    private void getWeChatLog(AccessibilityNodeInfo rootNode) {
        if (rootNode != null) {
            ...
            //获取最后一行聊天的线性布局（即是最新的那条消息）resource-id
            //
            //---------------------
            //
            //本文来自 haobaworenle 的CSDN 博客 ，全文地址请点击：https://blog.csdn.net/haobaworenle/article/details/71512823?utm_source=copy
